...
const MenuNavigationMobile = () => {
    return (
        <NavigationMenu orientation="vertical" className="md:w-[300px] sm:w-[200px]">
                        ...
                        <AccordionItem value="item-3">
                            ...
                            <AccordionContent>
                                <ul className="w-[200px] gap-3 p-4 md:w-[300px] md:grid-cols-2 lg:w-[600px] flex flex-col items-center justify-center ">
                                    <SheetClose asChild><ListItem href="/sobre/nossahistoria" title="Nossa História" className="text-center"></ListItem></SheetClose>
                                    <SheetClose asChild><ListItem href="/sobre/equipe" title="Equipe" className="text-center"></ListItem></SheetClose>
                                    <SheetClose asChild><ListItem href="/sobre/missaoevisao" title="Missão e Visão" className="text-center"></ListItem></SheetClose>
                                    <SheetClose asChild><ListItem href="/sobre/termosdeservico" title="Termos de Serviço" className="text-center"></ListItem></SheetClose>
                                    <SheetClose asChild><ListItem href="/sobre/politicadeprivacidade" title="Política de Privacidade" className="text-center"></ListItem></SheetClose>
                                    <SheetClose asChild><ListItem href="/sobre/contato" title="Contato" className="text-center"></ListItem></SheetClose>
                                </ul>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
